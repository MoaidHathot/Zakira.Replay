...
public sealed class ReplayTools
{
    ...
    public async Task<string> AnalyzeAsync(
        ...
        [Description("Number of representative frames to extract. Defaults to 15.")] int frames = 15,
    ...
    public string AnalyzeStart(
        ...
        [Description("Optional focus signal appended to the OCR prompt.")] string? ocrInstruction = null,
        [Description("Skip transcript extraction (frame-only run).")] bool noTranscript = false,
        [Description("Number of representative frames to extract.")] int frames = 15,
    ...
    public async Task<string> QueueEnqueueAsync(
        ...
        [Description("Frame count.")] int frames = 15,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var request = new AnalyzeRequest(
            ...
            Force: force,
            UseCache: cache,
            FrameStrategy: everyFrame ? FrameSelectionStrategies.EveryFrame : (frameStrategy ?? FrameSelectionStrategies.Interval),
            CookiesPath: cookies,
